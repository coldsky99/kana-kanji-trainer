...
const translations = {
  en: {
    ...
    'login.toggleToRegisterPrompt': "Don't have an account?",
    'login.toggleToRegisterLink': 'Register',
    'login.toggleToLoginPrompt': 'Already have an account?',
    'login.toggleToLoginLink': 'Sign In',
    'login.error.invalidEmail': 'Please enter a valid email address.',
    'login.error.passwordTooShort': 'Password must be at least 6 characters long.',
    'login.error.passwordsDoNotMatch': 'Passwords do not match.',
    'login.error.auth/email-already-in-use': 'This email address is already in use.',
    'login.error.auth/invalid-credential': 'Invalid email or password. Please try again.',
    'login.error.auth/weak-password': 'Password is too weak. Please choose a stronger password.',
    'login.error.default': 'An unexpected error occurred. Please try again.',
    ...
    'achievements.katakana_master.name': 'Katakana Master',
    'achievements.katakana_master.description': 'Learn all basic katakana characters.',
    'achievements.kanji_adept.name': 'Kanji Adept',
    'achievements.kanji_adept.description': 'Learn 50 kanji.',
    'achievements.level_10.name': 'Level 10 Reached',
    'achievements.level_10.description': 'Reach level 10.',
    'achievements.persistent_learner.name': 'Persistent Learner',
    'achievements.persistent_learner.description': 'Maintain a 7-day streak.',
  ...
  id: {
    ...
    'login.confirmPasswordLabel': 'Konfirmasi Kata Sandi',
    'login.signInButton': 'Masuk',
    'login.createAccountButton': 'Buat Akun',
    'login.toggleToRegisterPrompt': 'Belum punya akun?',
    'login.toggleToRegisterLink': 'Daftar',
    'login.toggleToLoginPrompt': 'Sudah punya akun?',
    'login.toggleToLoginLink': 'Masuk',
    'login.error.invalidEmail': 'Harap masukkan alamat email yang valid.',
    'login.error.passwordTooShort': 'Kata sandi harus minimal 6 karakter.',
    'login.error.passwordsDoNotMatch': 'Kata sandi tidak cocok.',
    'login.error.auth/email-already-in-use': 'Alamat email ini sudah digunakan.',
    'login.error.auth/invalid-credential': 'Email atau kata sandi tidak valid. Silakan coba lagi.',
    'login.error.auth/weak-password': 'Kata sandi terlalu lemah. Silakan pilih kata sandi yang lebih kuat.',
    'login.error.default': 'Terjadi kesalahan tak terduga. Silakan coba lagi.',
    ...
    'achievements.katakana_master.name': 'Master Katakana',
    'achievements.katakana_master.description': 'Pelajari semua karakter dasar katakana.',
    'achievements.kanji_adept.name': 'Ahli Kanji',
    'achievements.kanji_adept.description': 'Pelajari 50 kanji.',
    'achievements.level_10.name': 'Mencapai Level 10',
    'achievements.level_10.description': 'Capai level 10.',
    'achievements.persistent_learner.name': 'Pelajar Tekun',
    'achievements.persistent_learner.description': 'Pertahankan rentetan 7 hari.',
